...
=> Prioritas CSS selector ditentukan oleh specificity (tingkat kekhususan) dan aturan cascade. Urutannya sendiri adalah
Inline style (misalnya style="color:red"), ID selector (#header, #content), Class, attribute, dan pseudo-class selector (.box, [type="text"], :hover), tag/element selector (div, h1, p) dan pseudo-element (::before, ::after) menjadi prioritas paling rendah.Kalau dua aturan punya specificity sama, maka aturan yang ditulis paling akhir di CSS akan dipakai. 

2. Mengapa responsive design menjadi konsep yang penting dalam pengembangan aplikasi web? Berikan contoh aplikasi yang sudah dan belum menerapkan responsive design, serta jelaskan mengapa!
=> Responsive design penting karena di zaman sekarang pengguna mengakses web dari berbagai perangkat seperti laptop, tablet, Handphone dengan ukuran layar yang berbeda-beda. Tanpa adanya responsive design maka tampilan website bisa berantakan, teks susah dibaca, dan tombol sulit diklik, sehingga pengalaman pengguna menjadi kurang nyaman.

Contoh yang sudah menerapkan seperti YouTube memiliki tampilannya otomatis menyesuaikan layar. Di HP, video memenuhi layar dengan menu sederhana, sedangkan di desktop ada sidebar dan fitur yang lebih lengkap. Tokopedia juga mudah dipakai di HP maupun laptop karena tampilannya otomatis menyesuaikan.

Contoh yang belum menerapkan, seperti Situs lama pemerintahan atau blog lama dengan layout fixed-width → di HP sering harus zoom in/out, tombol terlalu kecil, dan navigasi susah.

3. Jelaskan perbedaan antara margin, border, dan padding, serta cara untuk mengimplementasikan ketiga hal tersebut!
=> Margin itu merupakan jarak di luar elemen, fungsinya untuk memberi ruang antar elemen. Kemudian border adalah garis tepi elemen, bisa diatur ketebalan, warna, dan gayanya. Sedangkan, padding adalah jarak di dalam elemen, antara konten dengan border.
Untuk cara pengimplementasikannya Margin → Border → Padding → Content.

4. Jelaskan konsep flex box dan grid layout beserta kegunaannya!
=> Flexbox itu cocok digunakan ketika ingin mengatur elemen dalam satu arah, baik secara horizontal (baris) maupun vertikal (kolom). Dengan Flexbox, elemen bisa otomatis menyesuaikan ukuran agar tetap rapi, sehingga sangat berguna untuk membuat navbar, tombol sejajar, atau daftar card yang fleksibel mengikuti ukuran layar. Sedangkan Grid Layout, yaitu bisa mengatur baris dan kolom sekaligus. Grid cocok dipakai untuk membuat layout yang lebih kompleks dan terstruktur, misalnya dashboard, galeri foto, atau desain halaman penuh dengan beberapa bagian. Dengan Grid, kita bisa menentukan jumlah kolom, ukuran baris, serta jarak antar elemen dengan lebih tepat.
